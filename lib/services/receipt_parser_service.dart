      ...
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          'system':
              ...
              '- Each item has name, quantity, unit (e.g. pcs, kg, L),\n'
              '  unit_price, and total_price\n'
              '- If quantity is not clearly shown on the receipt,\n'
              '  set quantity_low_confidence to true and use your\n'
              '  best estimate — do NOT silently default to 1\n'
              '- Service fees, tips, and delivery charges that are\n'
              '  separate from product lines go in service_charge,\n'
              '  not as regular items unless they appear as line items\n'
              '- Store discounts and returns: use discount_total for\n'
              '  receipt-level discounts; negative-return lines may\n'
              '  appear as items with negative total_price\n'
              ...
              '      "quantity": number,\n'
              '      "unit": "pcs or kg or L or null",\n'
              '      "unit_price": number,\n'
              '      "total_price": number,\n'
              '      "quantity_low_confidence": boolean,\n'
